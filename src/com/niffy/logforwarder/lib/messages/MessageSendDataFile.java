...
public class MessageSendDataFile extends Message {
	// ===========================================================
	// Constants
	// ===========================================================
	@SuppressWarnings("unused")
	private final Logger log = LoggerFactory.getLogger(MessageSendDataFile.class);
	...
	public MessageSendDataFile() {
		super();
	}

	public MessageSendDataFile(final int pVersion, final int pFlag) {
